...
train_data, valid_data, test_data = datasets.UDPOS.splits(fields, root='/home/student/.data')
...
def run(rank=0):
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        train_loss, train_acc = train(model, train_iterator, optimizer, criterion, TAG_PAD_IDX, rank, epoch)
